...
<head>
    ...
    <title>Customized Holiday Tour Packages, Personalized Vacation | Anureet Holidays</title>
    <meta name="description"
        content="Book customized tour packages at Anureet Holidays for an unforgettable travel experience. Best offers on customized international holiday packages to match your budget and travel needs. Call for personalized vacation today.">
    <meta name="keywords"
        content="india tour, tours in india, india tourism portal, travel guide india, incredible india, india tourism">
    <meta property="og:title" content="Customized Holiday Tour Packages, Personalized Vacation | Anureet Holidays" />
    ...
    <meta name="twitter:description"
        content="Book customized tour packages at Anureet Holidays for an unforgettable travel experience. Best offers on customized international holiday packages to match your budget and travel needs. Call for personalized vacation today." />
    <meta name="twitter:title" content="Customized Holiday Tour Packages, Personalized Vacation | Anureet Holidays" />
            ...
            <div class="container">
                <div class="banner-heading">
                    <span>Get Personalized Itineraries</span>
                     <p>Tailor-made Itinerary for you! Tell us what you want and we will design it for you or explore our special packages.</p>
                </div>
            </div>
            <div class="baseline">
                <div class="container">
         ...
         <div class="contact-info ">
           <div class="main-heading mb-3">
                <h2>Best in Entire Indian Subcontinent!</h2>
                        ...
                        <p class="text-justify">To ensure we create the best-in-class experience for you, please provide us with some key details. This will allow us to design a personalized itinerary that maximizes your time and captures the essence of your destination. Providing any specific interests, activities, or landmarks you'd like to include. 
<br><br>
Our team of travel experts will curate a tailor-made itinerary, encompassing top attractions, hidden gems, dining recommendations, and local insights. Your journey begins here, and we can't wait to craft a remarkable adventure just for you!
<br><br>
You can also call us at your preferred time.
<br>
Just click on the link below:
<br>
</p><center><a style="    background: #ff0505;
    border-color: #ff0505;" class="btn btn-primary" href="tel:+91852968526">Call Now</a></center><p></p>
                    </div>
        </div>
    </div></div>
</section>
