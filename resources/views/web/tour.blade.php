...
<head>
    ...
    <meta name="keywords" content="{{$tour->tours_name}},Anureet Holidays, Tour Packages">
            ...
            <div class="col-lg-12 mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList">
                        ...
                        if ($destination!=null) {
                            @endphp
                        <li class="breadcrumb-item"><a href="{{url('/packages/'.$destination->destination_slug)}}"><span
...
<li class="breadcrumb-item"><a href="{{url('/category/'.$subcategory->slug)}}"><span
    ...
    <meta itemprop="position" content="2">
                        ...
                        <li style="color:black;" class="breadcrumb-item active"  aria-current="page"><span itemprop="name"><a>{{$tour->tours_name}}</a></span>
                    ...
                    <div id="overview" class="col-lg-12 overview_box mt-3">
                        ...
                        <div class="row mt-3 package_deal">
                            ...
                            <div class="col-6 col-lg-3 col-md-4 destination">
                                <div class="rounded-circle destination-circle"><img src="{{asset('assets/images/'.$sinc.'.png')}}"
                  ...
                  <div class="col-lg-12 bottom-links mt-2 ">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Inclusions</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link " id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Exclusions</button>
                      </li>
                    </ul>
                  </div>
                  <div class="col-lg-12">
            ...
            <div id="hotels" class="col-lg-12 mb-4 inclusions_and_exclusions overview_box">
               <h3>Hotels</h3>
                <div class="row">
                   ...
                   <div class="card"  >
  <img src="{{ Storage::url($res->hotel_banner) }}" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title" style="    font-size: 15px;">{{$res->hotel_name }}</h5>
    <p class="p-0 m-0"  style="    font-size: 13px;">{{$res->hotel_location }}</p>
