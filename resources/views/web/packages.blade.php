...
<head>
    ...
    <title>{{$destination->destination_name}} Tour Packages | Anureet Holidays</title>
    <meta name="description"
        content="{{$destination->destination_seo_description}}">
    <meta name="keywords"
        content="{{$destination->destination_name}},Anureet Holidays">
    <meta property="og:title" content="{{$destination->destination_name}} Tour Packages | Anureet Holidays" />
    ...
    <meta name="twitter:description"
        content="{{$destination->destination_seo_description}}" />
    <meta name="twitter:title" content="{{$destination->destination_name}} Tour Packages | Anureet Holidays" />
...
<body>
    ...
    @include('web.header')
        ...
        <section class="banner-sec" style="background-image:url('{{ Storage::url($destination->destination_banner_image) }}')">
            <div class="container">
                        ...
                        <div class="destination_card-inner mb-3">
                            <div class="row">
                                <div class="col-12 col-md-4 destinationimg col-12"><img
                                        src="{{ Storage::url($res->tours_banner) }}"
                                        alt="" class="w-100"></div>
                                        ...
                                        <div class="inner">
                                            ...
                                            <div class="d-flex flex-wrap justify-content-around"><button type="button"
                                                    class="mybtn"><a
                                                        ...
                                                        style="text-decoration: none; color: white;">Explore Now</a></button><button
                                                    type="button" class="mybtn1" data-bs-toggle="modal"
                                                    data-bs-target="#form46">Enquire Now</button></div>
