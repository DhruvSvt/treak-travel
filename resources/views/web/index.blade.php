...
<body>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="trend-sec-left">
                        <a href="{{url('/packages/'.$res->destinations->destination_slug)}}" target="_blank"><img
                                src="{{ Storage::url( $res->featured_destination_image) }}"
                                alt="{{$res->featured_destination_name}}">
    ...
    <section class="banner d-flex my-5 p-0">
        <div class="banner-sec">
            <div class="banner-left">
                ...
                <div>
                    <div class="best-holiday-sec">
                        <a href="{{url('/'.$res->slug.'/'.$res->id)}}"><img height="200"
                                src="{{ Storage::url($res->destination_card_image) }}"
                                alt="{{$res->destionation_type_name}} Tour Packages"></a>
                        <div class="bh-content common-hover">
                            <h4><a href="{{url('/'.$res->slug.'/'.$res->id)}}">{{$res->destionation_type_name}}
                                    <br>Tours Packages</a>
                            </h4>
                        </div>
                    </div>
    ...
    <section class="more-info p-tb">
        <div class="container1">
            <div class="more-info-sec page-btn">
                ...
                <p>
                    Traveling in India can be a transformative experience due to its rich cultural tapestry, diverse
                    landscapes, and historical significance. Here's an overview of what to expect when traveling in
                    India:

                </p>
                <p><b>Cultural Diversity:</b> India is a melting pot of cultures, languages, religions, and traditions.
                    Each region of the country has its own distinct identity, offering travelers a unique and immersive
                    experience.

                </p>
                <p><b>Historical Landmarks:</b> India is home to numerous historical landmarks, including ancient
                    temples, palaces, forts, and monuments. The Taj Mahal in Agra, the forts of Rajasthan, the temples
                    of Varanasi, and the cave temples of Ajanta and Ellora are just a few examples of India's rich
                    architectural heritage.

                </p>
                <p><b>Spirituality and Religion:</b> India is the birthplace of several major religions, including
                    Hinduism, Buddhism, Jainism, and Sikhism. Travelers can visit sacred sites, participate in religious
                    rituals and festivals, and explore the spiritual aspects of Indian culture.

                </p>
                <p><b>Natural Beauty:</b> From the snow-capped peaks of the Himalayas to the sun-kissed beaches of Goa
                    and Kerala, India offers a diverse range of natural landscapes. Travelers can explore national
                    parks, wildlife sanctuaries, hill stations, and backwaters, experiencing the country's biodiversity
                    and natural beauty.

                </p>
                <p><b>Cuisine:</b> Indian cuisine is renowned for its variety, flavor, and complexity. Each region of
                    India has its own unique culinary traditions, influenced by local ingredients and cultural
                    practices. Travelers can indulge in a wide array of dishes, from spicy curries and street food to
                    vegetarian thalis and traditional sweets.

                </p>
                <p><b>Transportation:</b> India has a well-developed transportation network, including trains, buses,
                    taxis, and domestic flights. While traveling within cities, options like auto-rickshaws and cycle
                    rickshaws are common. Trains are a popular and affordable mode of long-distance travel, offering a
                    chance to interact with locals and take in the scenic countryside.

                </p>
                <p><b>Challenges:</b> Traveling in India can also present certain challenges, such as crowded streets,
                    traffic congestion, pollution, and cultural differences. It's important for travelers to exercise
                    caution, respect local customs, and be mindful of safety and hygiene practices.

                </p>
                <p><b>Hospitality:</b> Indian hospitality is renowned for its warmth and generosity. Travelers can
                    expect to encounter friendly locals who are often eager to share their culture, traditions, and
                    stories.

                </p>
                <p> Overall, traveling in India offers a rich and rewarding experience, allowing visitors to immerse
                    themselves in a tapestry of history, spirituality, cuisine, and natural beauty unlike anywhere else
                    in the world. With proper planning and an open mind, exploring India can be an unforgettable journey
                    of discovery.</p>
