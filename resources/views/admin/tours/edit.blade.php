                        ...
                        <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select class="form-control select2" required
                                                    name="tourSelectInclusion[]" multiple="multiple">
                                                    @foreach ($tourPreInclusion as $response)
                                                                <option value="{{ $response }}"
                                                                    {{ in_array($response,$tourResponse->select_inclusion) ? 'selected' : null }}>
                                                                    {{ $response }} </option>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select class="form-control select2" required name="tour_type">
                                                    <option value="Standard"
                                                        {{ $tourResponse->tour_type == 'Standard' ? 'selected' : null }}>
                                                        Standard</option>
                                                    <option value="Deluxe"
                                                        {{ $tourResponse->tour_type == 'Deluxe' ? 'selected' : null }}>Deluxe
                                                    </option>
                                                    <option value="Premium"
                                                        {{ $tourResponse->tour_type == 'Premium' ? 'selected' : null }}>
                                                        Premium</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="tours_url" value="{{ $tourResponse->tours_url }}"
                                                    id="tourUrl" class="form-control" type="text" required />
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="tours_duration"
                                                    value="{{ $tourResponse->tours_duration }}" class="form-control"
                                                    type="text" required />
                                            </div>
                                            <div class="form-group col-sm-12">
                                                <label for="short_description">Short Description</label>
                                                <textarea name="tours_description" value="{{ $tourResponse->tours_description }}" required class="form-control">{{ $tourResponse->tours_description }}</textarea>
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select class="form-control select2" required name="tourDestinations[]"
                                                    ...
                                                    @foreach ($destinationResponse as $response)
                                                     <option value="{{ $response->destination_id }}" {{ in_array($response->destination_id,$sdes)?
                                                        'selected' : null }}>
                           ...
                           $sdes = array();
                                           ...
                                           <div class="form-group col-sm-6">
                                            ...
                                            <select class="form-control select2" name="tourHotels[]" multiple="multiple">
                                                ...
                                                <select class="form-control select2" id="tourCategory" required
                                                    ...
                                                    @foreach ($categoryResponse as $response)
                                                        <option value="{{ $response->id }}"
                                                            {{ $response->id == $tourResponse->tours_category ? 'selected' : null }}>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select class="form-control select2" id="tourSubCategory" required
                                                    ...
                                                    @foreach ($subcategoryResponse as $response)
                                                        <option value="{{ $response->tour_subcategories_id }}"
                                                            {{ $response->tour_subcategories_id == $tourResponse->tours_subcategory ? 'selected' : null }}>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <textarea id="overview" name="tours_overview" class="form-control">{{$tourResponse->tours_overview}}</textarea>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="text">Inclusion</label>
                                                <textarea id="inclusion" name="tours_inclusion" class="form-control">{{$tourResponse->tours_inclusion}}</textarea>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="text">Exclusion</label>
                                                <textarea id="exclusion" name="tours_exclusion" class="form-control">{{$tourResponse->tours_exclusion}}</textarea>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="text">Disclaimer</label>
                                                <textarea id="disclaimer" name="tours_disclaimer" class="form-control">{{$tourResponse->tours_disclaimer}}</textarea>
                                            </div>
                                            <div class="form-group col-sm-12">
                                                <div style="border: 1px solid #ddd;background: #f2f2f2;padding:5px">
                                                    <label for="email">Tour Plan &nbsp; <a
                                                            href="javascript:void(0)" id="addcustom_adultprice"
                                                    ...
                                                    @foreach ($tourItineiryResponse as $response)
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-sm-12 ">
                                                                    <textarea class="plan_desc"  name="plan_desc[]" rows="4" class="form-control " placeholder="Tour Plan Detail">{{ $response->tours_itineries_desc }}</textarea>
                                                                </div>
                                                            </div>
