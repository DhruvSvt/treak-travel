        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Our Accreditations List</h1>
                    <a href="add-our-accreditations" class="ml-3 btn btn-primary">Add Our Accreditations </a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card text-left">
                            ...
                            <div class="card-body">
                                <h4 class="card-title mb-3"> Our Accreditations </h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="img-thumbnail" style="width:200px;"
                                                        src="{{ Storage::url( $response->our_accreditation_image) }}" />
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{route('delete-accreditations',['id'=>$response->id])}}" class="text-primary mr-2">
