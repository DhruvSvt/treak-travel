        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>HomePage Banner List</h1>
                    <a href="homepageBanner-add" class="ml-3 btn btn-primary">Add Banner</a>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="text-primary mr-2" href="{{route('edit-homepageBanner',['id'=>$response->id])}}">
                                                        <span class="btn btn-sm btn-primary">
                                                            <i class="nav-icon i-Pen-3"></i> Edit
                                                        </span>
                                                    </a>
                                                    <a href="{{route('delete-homepageBanner',['id'=>$response->id])}}" class="text-primary mr-2">
