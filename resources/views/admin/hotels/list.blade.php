        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="">Hotels List </h1>
                    <a href="hotels-add" class="ml-3 btn btn-primary">Add Hotels</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card text-left">
                            ...
                            <div class="card-body">
                                <h4 class="card-title mb-3"> Hotels</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="myTable">
                                        ...
                                        <tbody>
                                            @foreach ($hotels as $response)
                                                <tr>
                                                    <td class="text-right">#{{ $response->id }}</td>
                                                    <td>{{ $response->hotel_name }}</td>
                                                    <td>{{ $response->hotel_location }}</td>
                                                    <td>
                                                        <img class="img-thumbnail" style="width:200px;"
                                                            src="{{ Storage::url($response->hotel_banner) }}" />
                                                    </td>
                                                    <td class="text-center">
                                                        <label class="switch switch-success mr-3">
                                                            ...
                                                            <input type="checkbox" id="statusCheckbox"
                                                                ...
                                                                onChange='statusChanged({{ $response->id }},{{ $response->status }})'>
                                                            <span class="slider"></span>
                                                        </label>
                                                    </td>
                                                    <td class="text-center">
                                                        <a class="text-primary mr-2"
                                                            href="{{ route('edit-hotel', ['id' => $response->id]) }}">
                                                            <span class="btn btn-sm btn-primary">
                                                                <i class="nav-icon i-Pen-3"></i> Edit
                                                            </span>
                                                        </a>
                                                        <a href="{{ route('delete-hotel', ['id' => $response->id]) }}"
