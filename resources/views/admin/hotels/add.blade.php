                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="{{ route('create-hotel') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input name="hotel_location" class="form-control" type="text" required />
                                        </div>

                                        <div class="form-group col-sm-6">
                                            <label for="title">Rate the Hotel</label>
                                            <input name="hotel_rate" oninput="onRateChangeHandler(this)" id="hotel_rate"
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <input type="file" name="hotel_banner"
