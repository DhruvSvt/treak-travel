        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="">Best Deals of The Season </h1>
                    <a href="add-best-shortbrake-destination" class="ml-3 btn btn-primary">Add Best Short Brake Destination</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card text-left">
                            ...
                            <div class="card-body">
                                <h4 class="card-title mb-3"> Best Deals of The Season</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($shortbrakeDestinationResponse as $response)
                                            <tr>
                                                <td class="text-right">#{{$response->shortbrake_destination_id }}</td>
                                                <td>{{$response->shortbrake_destination_name }}</td>
                                                ...
                                                <td>
                                                    <img class="img-thumbnail" style="width:200px;"
                                                        src="{{ Storage::url( $response->shortbrake_destination_image) }}" />
                                                </td>
                                                <td>{{$response->shortbrake_price }}</td>
